...
export default function IpDisplay() {
  ...
  return (
    <div className="fixed top-2 right-2 z-[100] flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-cyan-400/40 bg-background/90 backdrop-blur-md text-[10px] font-mono text-cyan-300 shadow-[0_0_12px_rgba(0,217,255,0.25)] select-none">
